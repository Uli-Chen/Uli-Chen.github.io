...
In our previous post, we explored how Flow and Diffusion models define trajectories using ODEs and SDEs. However, a key question remains: What exactly should the neural network learn to approximate?

In this post, we dive into the mathematics of Constructing the Training Target. We will bridge the gap between individual data points and global distributions by exploring:

- The relationship between Conditional and Marginal Probability Paths.

- The Marginalization Trick: A powerful tool to simplify complex vector fields.

- How the Continuity Equation and Fokker-Planck Equation provide the formal foundation for Flow Matching and Diffusion.

By the end of this tutorial, you will understand how a Gaussian conditional path leads to the practical training objectives used in state-of-the-art generative models.
